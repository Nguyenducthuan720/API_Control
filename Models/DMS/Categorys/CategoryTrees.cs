...
{
    public static class CategoryGeneralTrees
    {
        public class Requets
        {
            public class Content
            {
                ...
                ///InfoDescription
                /// </summary>
                /// <example>InfoDescription</example>
            ...
            public class GetByParentID: Get
            {
                public int? ParentID { get; set; }
            }

            public class GetByLevel : Get
            {
                public int? Level { get; set; }
            }
            ...
            public class GetByListParentID: Get
            {
