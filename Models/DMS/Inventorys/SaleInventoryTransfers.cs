...
{
    public static class SaleInventoryTransfers
    {
        public static class Request
        {
            ...
            public class AddOrEdit
            {
                ...
                /// <summary>
                /// Nhà máy nhận (nhập kho)
                /// </summary>
                public int? FactoryInID { get; set; }

                /// <summary>
                /// Nhà máy xuất (xuất kho)
                /// </summary>
                public int? FactoryOutID { get; set; }
            ...
            public class Detail : GetByOID
            {
                ...
                /// Chi tiết đơn hàng
                /// </summary>
                public List<AddHoldItem> Details { get; set; }
            }

            public class AddHoldItem 
            {
                /// <summary>
                /// Sản phẩm
                /// </summary>
