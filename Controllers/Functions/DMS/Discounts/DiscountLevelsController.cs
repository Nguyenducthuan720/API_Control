...
{
    [ApiExplorerSettings(GroupName = "Functions.Discounts.DiscountLevels")]
    [Authorize]
    [Route("api/[controller]/[action]")]
    [ApiController]
    public class DiscountLevelsController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _CategoryDB;
        private readonly string _ProcedureName = "ExecDiscountLevels";

        public DiscountLevelsController(UserInfo userInfo)
        {
            _UserInfo = userInfo;
        ...
        [HttpPost]
        public async Task<IActionResult> GetById([FromBody] DiscountLevels.Request.GetByID request)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] DiscountLevels.Request.AddOrEdit request)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit([FromBody] DiscountLevels.Request.AddOrEdit request)
        {
            try
            {
                var dataJson = JsonConvert.SerializeObject(request.Details);
        ...
        [HttpPost]
        public async Task<IActionResult> Delete([FromBody] DiscountLevels.Request.Del request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> Submit([FromBody] DiscountLevels.Request.Submit request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
