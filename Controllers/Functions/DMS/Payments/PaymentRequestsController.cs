...
[ApiExplorerSettings(GroupName = "Functions.Payments.PaymentRequests")]
...
public class PaymentRequestsController : ControllerBase
{
    ...
    private readonly string _ProcedureName = "ExecPaymentRequests";

    public PaymentRequestsController(UserInfo userInfo)
    {
        _UserInfo = userInfo;
    ...
    [HttpPost]
    public async Task<IActionResult> GetByID([FromBody] PaymentRequests.Request.GetByOID request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Add([FromBody] PaymentRequests.Request.Add request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Edit([FromBody] PaymentRequests.Request.Add request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Delete([FromBody] PaymentRequests.Request.Del request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Submit([FromBody] PaymentRequests.Request.Submit request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
