...
[ApiExplorerSettings(GroupName = "Functions.Plans.PromotionGiftPlans")]
[Route("api/[controller]/[action]")]
[Authorize]
[Authorize] 
[ApiController]
public class PromotionGiftPlansController : ControllerBase
{
    private readonly UserInfo _UserInfo;
    private readonly string _ConfigurationDB;
    private readonly string _SecondaryDB;
    private readonly string _ProcedureName = "ExecPromotionGiftPlans";

    public PromotionGiftPlansController(UserInfo userInfo)
    {
        _UserInfo = userInfo;
    ...
    [HttpPost]
    public async Task<IActionResult> GetByID([FromBody] PromotionGifts.Request.GetByOID request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Add([FromBody] PromotionGiftPlans.Request.Add request)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Edit([FromBody] PromotionGiftPlans.Request.Add request)
    {
        try
        {
            var contentDetails = JsonConvert.SerializeObject(request.Details);
    ...
    [HttpPost]
    public async Task<IActionResult> Delete([FromBody] PromotionGiftPlans.Request.Del request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Submit([FromBody] PromotionGiftPlans.Request.Submit request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
