...
[ApiExplorerSettings(GroupName = "Functions.SaleInventorys.SaleInventoryImports")]
[Route("api/[controller]/[action]")]
[Authorize]
[ApiController]
public class SaleInventoryImportsController : ControllerBase
{
    private readonly UserInfo _UserInfo;
    private readonly string _ConfigurationDB;
    private readonly string _SecondaryDB;
    private readonly string _ProcedureName = "ExecSaleInventoryImports";
    
    public SaleInventoryImportsController(UserInfo userInfo)
    {
        _UserInfo = userInfo;
    ...
    [HttpPost]
    public async Task<IActionResult> GetByID([FromBody] SaleInventoryImports.Request.GetByOID request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Add([FromBody] SaleInventoryImports.Request.AddOrEdit request)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Edit([FromBody] SaleInventoryImports.Request.Edit request)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Delete([FromBody] SaleInventoryImports.Request.Del request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
    ...
    [HttpPost]
    public async Task<IActionResult> Submit([FromBody] SaleInventoryImports.Request.Submit request)
    {
        try
        {
            Dictionary<string, object> parameters = new()
