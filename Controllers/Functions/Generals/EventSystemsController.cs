...
{
    [ApiExplorerSettings(GroupName = "Microservice.Category.EventSystems")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class EventSystemsController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _CategoryDB;
        private readonly string _ProcedureName = "[ExecEventSystems]";
        private readonly DBFolder _SettingOther;
        private readonly GoogleTranslateService _translate;

        public EventSystemsController(UserInfo userInfo, GoogleTranslateService googleTranslate)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetParamByType([FromBody] EventSystems.Requets.ByEntry request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
                {
                    { "@type", "Get-ParameterByType" },
                    { "@language", _UserInfo.Language },
                    { "@UserIDCurent", _UserInfo.UserID },
                    { "@CmpnID", _UserInfo.CmpnID }
                };
        ...
        [HttpPost]
        public async Task<IActionResult> GetByID([FromBody] EventSystems.Requets.GetByID request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] EventSystems.Requets.Add request)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit([FromBody] EventSystems.Requets.Edit request)
        {
            try
            {
                var datas = JsonConvert.SerializeObject(request.Datas);
        ...
        [HttpPost]
        public async Task<IActionResult> Delete([FromBody] EventSystems.Requets.GetByID request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
