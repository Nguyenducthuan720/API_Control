...
using static APISmartCity.Models.TMS.DataBeginStartsVehicle.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.DataBeginStartsVehicles")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class DataBeginStartsVehiclesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecDataBeginStartsVehicles";

        public DataBeginStartsVehiclesController(UserInfo userInfo)
        {
        ...
        public async Task<IActionResult> Add([FromBody] Add request)
        {
            try
            {
                ...
                if (request.Details != null)
                {
                    ...
                    details.SetTypeName("DataBeginStartsVehicleDetail");
                    request.Details = null;
                    parameters.Add("@DataBeginStartsVehicleDetails", details);
                }
                DataResponse dataResponse = await GetDataResponse(parameters, _nPLDB, _ConfigurationDB, _ProcedureName, request);
                return Ok(dataResponse);
            }
