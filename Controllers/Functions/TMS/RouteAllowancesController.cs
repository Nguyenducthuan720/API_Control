...
using static APISmartCity.Models.TMS.RouteAllowances.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.RouteAllowances")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class RouteAllowancesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecRouteAllowances";

        public RouteAllowancesController(UserInfo userInfo)
        {
        ...
        public async Task<IActionResult> GetById([FromBody] GetByID request)
        {
            try
            {
                ...
                if (dataResponse.Result!.Count > 1)
                {
                    ...
                    result.ChargingStation = dataResponse.Result[1];
        ...
        public async Task<IActionResult> Add([FromBody] Add request)
        {
            try
            {
                ...
                if (request.RouteAllowancesDetails != null)
                {
                    DataTable RouteAllowancesWorks = request.RouteAllowancesDetails.ToDataTable();
                    RouteAllowancesWorks.SetTypeName("RouteAllowancesDetail");
                    parameters.Add("@RouteAllowancesDetail", RouteAllowancesWorks);
                    request.RouteAllowancesDetails = null;
                }
                DataResponse dataResponse = await GetDataResponse(parameters, _nPLDB, _ConfigurationDB, _ProcedureName, request);
                return Ok(dataResponse);
            }
