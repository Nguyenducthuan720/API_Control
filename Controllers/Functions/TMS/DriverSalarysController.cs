...
using static APISmartCity.Models.TMS.DriverSalarys.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.DriverSalarys")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class DriverSalarysController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecDriverSalarys";

        public DriverSalarysController(UserInfo userInfo)
        {
