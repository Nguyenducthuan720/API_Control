...
using static APISmartCity.Models.TMS.ShippingAndCreditnPLTotal.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.ShippingAndCreditnPLTotals")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class ShippingAndCreditnPLTotalController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecShippingAndCreditnPLTotals";

        public ShippingAndCreditnPLTotalController(UserInfo userInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetReference([FromBody] Get request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        public async Task<IActionResult> Add([FromBody] Add request)
        {
            try
            {
                ...
                {
                    parameters.Add("@Details", JsonSerializer.Serialize(request.Details));
