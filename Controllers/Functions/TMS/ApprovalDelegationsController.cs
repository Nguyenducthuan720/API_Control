...
using static DMS.Models.TMS.ApprovalDelegations.Request;


namespace DMS.Controllers.Functions.TMS
{
    [ApiExplorerSettings(GroupName = "Functions.ApprovalDelegations")]
    ...
    public class ApprovalDelegationsController : ControllerBase
    {
        ...
        private readonly string _ProcedureName = "ExecApprovalDelegation";

        public ApprovalDelegationsController(UserInfo userInfo)
        {
            _UserInfo = userInfo;
            _ConfigurationDB = Global.ListDB?.Find(item => item.DBType == "CON")?.DBString!;
            _nPLDB = Global.ListDB?.Find(item => item.DBType == "MDA")?.DBString!;
        }
        [HttpPost]
        ...
        [HttpPost]
        public async Task<IActionResult> GetByOID([FromBody] GetByOID request)
        {
            try
            {
