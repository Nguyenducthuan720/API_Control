...
using static APISmartCity.Models.TMS.ProcessDriverMaintenances.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.ProcessDriverMaintenances")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class ProcessDriverMaintenancesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecProcessDriverMaintenances";

        public ProcessDriverMaintenancesController(UserInfo userInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetNoDriver()
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> EditReceive([FromBody] Receive request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> ProcessReceive([FromBody] Receives request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> EditComplete([FromBody] Complete request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> BeforeReceive([FromBody] BeforeReceive request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateExpectTime([FromBody] UpdateExpectTime request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
                {
                    { "@type", "UpdateExpectTime" },
                    { "@language", _UserInfo.Language },
                    { "@UserIDCurent", _UserInfo.UserID },
                    { "@CmpnID", _UserInfo.CmpnID }
                };
        ...
        public async Task<IActionResult> UpdateQuantity([FromBody] UpdateQuantity request)
        {
            try
            {
                ...
                if (request.Details != null)
                {
                    ...
                    Details.SetTypeName("PmvDetails");
