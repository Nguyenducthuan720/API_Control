...
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.ShippingInvoices")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class ShippingInvoicesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecShippingInvoices";

        public ShippingInvoicesController(UserInfo userInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetDetailByCustomerID([FromBody] ShippingInvoices.Request.GetDetailByCustomer request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> GetCheckInvoices([FromBody] ShippingInvoices.Request.GetCheckInvoices request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
                {
                    { "@type", "GetCheckInvoices" },
                    { "@language", _UserInfo.Language },
                    { "@UserIDCurent", _UserInfo.UserID },
                    { "@CmpnID", _UserInfo.CmpnID }
                };
