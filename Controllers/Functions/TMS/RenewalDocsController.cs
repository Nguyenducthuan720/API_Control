...
using static APISmartCity.Models.TMS.RenewalDocs.Request;

namespace APISmartCity.Controllers.nPL
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.RenewalDocs")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class RenewalDocsController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecRenewalDocs";

        public RenewalDocsController(UserInfo userInfo)
        {
        ...
        public async Task<IActionResult> GetTotal()
        {
            try
            {
                ...
                if (dataResponse.Result!.Count > 1)
                {
                    ...
                    result.List = dataResponse.Result[0];
                    result.Dashboard = dataResponse.Result[1];
