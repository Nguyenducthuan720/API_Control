...
{
    [ApiExplorerSettings(GroupName = "Microservice.Category.nPLRoutes")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class nPLRoutesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _CategoryDB;
        private readonly string _ProcedureName = "ExecnPLRoutes";

        public nPLRoutesController(UserInfo userInfo)
        {
            _UserInfo = userInfo;
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] NPLRoutes.Request.Add request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> Check([FromBody] NPLRoutes.Request.Check request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> Edit([FromBody] NPLRoutes.Request.Edit request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> Delete([FromBody] NPLRoutes.Request.Del request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> ChangeStatus([FromBody] NPLRoutes.Request.EditStatus request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
