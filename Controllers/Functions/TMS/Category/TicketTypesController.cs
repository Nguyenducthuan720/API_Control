...
{
    [ApiExplorerSettings(GroupName = "Microservice.Category.TicketTypes")]
    ...
    public class TicketTypesController : ControllerBase
    {
        ...
        private readonly string _ProcedureName = "ExecTicketTypes";

        public TicketTypesController(UserInfo userInfo)
        {
            _UserInfo = userInfo;
