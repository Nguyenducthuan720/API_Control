...
using static APISmartCity.Models.TMS.ComplaintFeedback.Request;

namespace APISmartCity.Controllers.nPL
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.ComplaintFeedback")]
    ...
    public class ComplaintFeedbackController : ControllerBase
    {
        ...
        public ComplaintFeedbackController(UserInfo userInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetSaleContract([FromBody] GetByID request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
                {
                    { "@type", "GET-SaleContract" },
                    { "@language", _UserInfo.Language },
                    { "@UserIDCurent", _UserInfo.UserID },
                    { "@CmpnID", _UserInfo.CmpnID }
                };
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> GetShippings([FromBody] GetByID request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateFinal([FromBody] UpdateFinal request)
        {
            try
            {
                Dictionary<string, object> parameters = new()
