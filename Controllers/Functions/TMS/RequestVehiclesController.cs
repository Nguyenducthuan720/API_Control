...
using static APISmartCity.Models.TMS.RequestVehicles.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.RequestVehicles")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class RequestVehiclesController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecRequestVehicles";

        public RequestVehiclesController(UserInfo userInfo)
        {
