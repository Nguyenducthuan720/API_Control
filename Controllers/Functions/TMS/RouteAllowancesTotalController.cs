...
using static APISmartCity.Models.TMS.RouteAllowancesTotal.Request;

namespace APISmartCity.Controllers.TMS
{
    [ApiExplorerSettings(GroupName = "Microservice.nPL.RouteAllowancesTotal")]
    [Route("api/[controller]/[action]")]
    [Authorize]
    [ApiController]
    public class RouteAllowancesTotalController : ControllerBase
    {
        private readonly UserInfo _UserInfo;
        private readonly string _ConfigurationDB;
        private readonly string _nPLDB;
        private readonly string _ProcedureName = "ExecRouteAllowancesTotals";

        public RouteAllowancesTotalController(UserInfo userInfo)
        {
