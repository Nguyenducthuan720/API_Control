...
using static APISmartCity.Models.TMS.Documents.Request;

namespace APISmartCity.Controllers.nPL
{
    [ApiExplorerSettings(GroupName = "Functions.Documents")]
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        private readonly string _ProcedureName = "ExecDocuments";

        public DocumentsController(UserInfo userInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetEntryOS()
        {
            try
            {
                Dictionary<string, object> parameters = new()
